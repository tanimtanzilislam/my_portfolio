...
<ul>
    ...
    <li>
        Relevant Coursework: Data structires,Algorithm,Web Development,Data Communication,Digital Logic Design,Digital System Design,Computer Architecture,Data Base,Numerical Methods,Micropro
    </li>
</ul>
    </div>
