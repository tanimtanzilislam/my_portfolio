    ...
    return <section id="home" className="min-h-screen flex items-center justify-center relative">
        <div className="text-center z-10 px-14">
           ...
           <div className="flex justify-center space-x-4">
            <a href="#projects " className="bg-blue-500 text-white py-3 py-6 rounded font-medium transition relative overflow-hidden hover:-translate-y-0.5 hover-shadow-[0_0_15px_rgb]">
                View Projects
            </a>
           </div>
        </div>
